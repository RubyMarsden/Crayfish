...
class BackgroundSelectionDialog(QDialog):
    def __init__(self):
        ...
        self.box1 = QCheckBox(BackgroundCorrection.EXP.value)
        self.box1.method = BackgroundCorrection.EXP
        self.box1.setChecked(False)
        self.box1.stateChanged.connect(self.check_selection_is_valid)

        self.box2 = QCheckBox(BackgroundCorrection.LIN.value)
        self.box2.method = BackgroundCorrection.LIN
        self.box2.setChecked(False)
        self.box2.stateChanged.connect(self.check_selection_is_valid)

        self.box3 = QCheckBox(BackgroundCorrection.CONST.value)
        self.box3.method = BackgroundCorrection.CONST
